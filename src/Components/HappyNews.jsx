...
function HappyNews({ products: propProducts }) {
          ...
          >
            {defaultVariant && defaultVariant.images && (
              <div className='flex relative items-center justify-center'>
                ...
                {numericDiscount > 0 && (
                  <div className='bg-[#ff003c] text-white w-[38px] h-[38px] sm:w-[50px] sm:h-[50px] text-[10px] sm:text-[14px] absolute top-[10px] sm:top-[30px] right-[4px] sm:right-[6px] font-[700] font-[Montserrat,_sans-serif] flex justify-center items-center rounded-full'>
